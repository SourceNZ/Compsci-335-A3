...
void Main() {
    ...
    /*4 THIS IS THE HARD ONE*/    "http://localhost:8181/WcfDataService1.svc/Products()?$format=json&$orderby=ProductID&$filter=CategoryID eq null or SupplierID eq null or UnitPrice eq null or UnitsInStock eq null or UnitsOnOrder eq null&$select=ProductID,ProductName,CategoryID,SupplierID,UnitPrice,UnitsInStock,UnitsOnOrder",
